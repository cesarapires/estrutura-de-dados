/* 
    ...
    Solução de: Cesar Augusto Pires
*/
...
campeonato::campeonato(campeonato& campeonato){
    quantidadeDeCompetidores = campeonato.quantidadeDeCompetidores;
    capacidadeMaxima = campeonato.capacidadeMaxima;
    listaDeCompetidores = new competidor[capacidadeMaxima];
    copy(campeonato.listaDeCompetidores, campeonato.listaDeCompetidores + capacidadeMaxima, listaDeCompetidores);
}
...
void campeonato::redimensionarCapacidade() {
    int novaCapacidade = ceil(capacidadeMaxima * 1.5);
    competidor* novaLista = new competidor[novaCapacidade];

    int posicao = 0;
    while (posicao < capacidadeMaxima) {
        novaLista[posicao] = listaDeCompetidores[posicao];
        posicao++;
    }

    delete [] listaDeCompetidores;
    listaDeCompetidores = novaLista;
